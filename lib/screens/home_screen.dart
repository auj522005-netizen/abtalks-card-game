...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF0A0A0A), Color(0xFF1A1A1A), Color(0xFF0F0F0F)])),
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              PulseWidget(animation: _pulse, child: Container(
                ...
                decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFFE94560), boxShadow: [BoxShadow(color: const Color(0xFFE94560).withOpacity(0.4), blurRadius: 40, spreadRadius: 5)]),
              ...
              _infoCard('605', 'سؤال', Icons.question_answer_rounded, const Color(0xFFE94560)),
              const SizedBox(height: 12),
              _infoCard('6', 'بطاقات حرة', Icons.card_giftcard_rounded, const Color(0xFFE94560)),
              const SizedBox(height: 12),
              _infoCard('30', 'بطاقة AB#', Icons.tag_rounded, const Color(0xFFE94560)),
              const SizedBox(height: 12),
              _infoCard('1', 'نرد الأفعال', Icons.casino_rounded, const Color(0xFFE94560)),
              const SizedBox(height: 40),
              GestureDetector(
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const GameSetupScreen())),
                child: Container(
                  width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 18),
                  decoration: BoxDecoration(color: const Color(0xFFE94560), borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: const Color(0xFFE94560).withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 8))]),
              ...
              const SizedBox(height: 20),
              Text('v2.0.0', style: TextStyle(color: Colors.white.withOpacity(0.2), fontSize: 12)),
            ]),
          ),
        ),
      ),
  ...
  Widget _rule(String title, String desc) => Padding(padding: const EdgeInsets.only(bottom: 8), child: Container(
    padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: const Color(0xFFE94560).withOpacity(0.15), borderRadius: BorderRadius.circular(10), border: Border.all(color: const Color(0xFFE94560).withOpacity(0.3))),
    child: Row(children: [Text(title, style: const TextStyle(color: Color(0xFFE94560), fontWeight: FontWeight.bold, fontSize: 14)), const SizedBox(width: 8), Expanded(child: Text(desc, style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 13)))]),
  ));
}
